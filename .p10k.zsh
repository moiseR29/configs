# Generated by Powerlevel10k configuration wizard on 2020-05-04 at 23:21 -03.
...
() {
  ...
  typeset -g POWERLEVEL9K_RIGHT_PROMPT_ELEMENTS=(
    ...
    # docker_version        # .NET version (https://dotnet.microsoft.com)
